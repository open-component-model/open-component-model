...
func (g *Generator) buildAliasSchema(ti *universe.TypeInfo) *Schema {
	...
	case *ast.Ident: // type Foo string
		if prim := newPrimitiveSchema(t, ti.TypeSpec, ti.GenDecl, nil); prim != nil {
			prim.Comment = "generated by the ocm schema generation tool"
			prim.Schema = "https://json-schema.org/draft/2020-12/schema"
...
func (g *Generator) schemaForExprWithField(expr ast.Expr, ctx *universe.TypeInfo, field *ast.Field) *Schema {
	switch t := expr.(type) {
	case *ast.Ident:
...
func (g *Generator) schemaForIdentWithField(id *ast.Ident, ctx *universe.TypeInfo, field *ast.Field) *Schema {
