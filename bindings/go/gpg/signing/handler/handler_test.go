...
func TestGPGHandler_RoundTrip_PassphraseProtected(t *testing.T) {
	const passphrase = "s3cr3t-p@ssphrase"
...
func TestGPGHandler_WrongPassphrase(t *testing.T) {
	...
	privCreds := armoredPrivKeyWithPassphrase(t, entity, "wrong-passphrase")
...
func TestGPGHandler_CredentialIdentities(t *testing.T) {
	...
	require.Equal(t, gpgcredentials.IdentityTypeGPG, sigIdentity.GetType())
...
func armoredPrivKeyWithPassphrase(t *testing.T, entity *openpgp.Entity, passphrase string) map[string]string {
	...
	creds := map[string]string{
		gpgcredentials.CredentialKeyPrivateKeyPGP: buf.String(),
	}
	if passphrase != "" {
		creds[gpgcredentials.CredentialKeyPassphrase] = passphrase
	}
	return creds
}
...
func armoredPubKey(t *testing.T, entity *openpgp.Entity) map[string]string {
	...
	return map[string]string{
		gpgcredentials.CredentialKeyPublicKeyPGP: buf.String(),
	}
}
