...
// An alternative concept is to use the [v1alpha1.ResolverSpecProvider]
package v1

import (
	v1alpha1 "ocm.software/open-component-model/bindings/go/repository/component/resolver/v1alpha1"
)

var _ v1alpha1.ResolverSpecProvider
