...
func Test_ensureAbsolutePath_Unix(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			assert.Equalf(t, tt.wantPath, result, "ensureAbsolutePath(%v, %v)", tt.args.path, tt.args.workingDir)
		})
	}
}

func Test_ensureAbsolutePath_Windows(t *testing.T) {
