...
require (
	...
	ocm.software/open-component-model/bindings/go/credentials v0.0.11 // indirect
	...
	ocm.software/open-component-model/bindings/go/descriptor/runtime v0.0.0-20260505072254-1c17fcd5c971 // indirect
