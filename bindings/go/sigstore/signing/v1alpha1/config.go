...
//
// Endpoint discovery follows this precedence:
//  1. SigningConfig — cosign reads a local signing_config.json and discovers
//     Fulcio, Rekor, and TSA endpoints from it.
//  2. Explicit URL fields (FulcioURL, RekorURL, TimestampServerURL) — passed directly to cosign.
//  3. Neither set — Cosign's default behavior (--use-signing-config=true) fetches
