...
// ExtractCredentialConfig extracts credential configuration from a generic configuration.
// It filters the configuration for credential entries and merges them into a single config.
func ExtractCredentialConfig(config *genericv1.Config) (*Config, error) {
