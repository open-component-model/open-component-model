...
type CredentialPlugin interface {
	GetConsumerIdentity(credential runtime.Typed) (runtime.Identity, error)
	Resolve(identity runtime.Identity, credentials map[string]string) (map[string]string, error)
}
