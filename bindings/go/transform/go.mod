...
require (
	...
	ocm.software/open-component-model/bindings/go/cel v0.0.0-20251211122149-413b01a4c39a
...
require (
	...
	ocm.software/open-component-model/bindings/go/signing v0.0.0-20251202063600-c6103e0cea0f // indirect
)
