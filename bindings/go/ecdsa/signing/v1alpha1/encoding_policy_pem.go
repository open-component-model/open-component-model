...
const (
	// MediaTypePEM is the media type for a PEM-encoded ECDSA signature.
	...
	//   2. Insert the raw ASN.1 DER signature bytes into the block.
	//   3. Add the signing algorithm (e.g. "ECDSA-P256") as the "Signature Algorithm" header.
