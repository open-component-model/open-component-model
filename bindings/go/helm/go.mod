...
require (
	...
	ocm.software/open-component-model/bindings/go/descriptor/runtime v0.0.0-20250829160005-4d7a90840859 // indirect
	ocm.software/open-component-model/bindings/go/descriptor/v2 v2.0.1-alpha3 // indirect
	ocm.software/open-component-model/bindings/go/repository v0.0.0-20250829160005-4d7a90840859 // indirect
