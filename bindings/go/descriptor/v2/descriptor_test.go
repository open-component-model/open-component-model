...
func TestComponent_DeepCopy(t *testing.T) {
	// Setup
	original := &descriptorv2.Component{
		ComponentMeta: descriptorv2.ComponentMeta{
			ObjectMeta: descriptorv2.ObjectMeta{
				Name:    "test-component",
				Version: "1.0.0",
	...
	// Assert
	assert.NotSame(t, original, copied, "DeepCopy should return a new instance")
...
func TestComponent_DeepCopy_Nil(t *testing.T) {
	// Test
	var original *descriptorv2.Component
	copied := original.DeepCopy()
...
func TestDescriptor_DeepCopy(t *testing.T) {
	// Setup
	original := &descriptorv2.Descriptor{
		Meta: descriptorv2.Meta{
			Version: "v2",
		},
		Component: descriptorv2.Component{
	...
	// Assert
	assert.NotSame(t, original, copied, "DeepCopy should return a new instance")
	assert.Equal(t, original.Meta.Version, copied.Meta.Version)
	assert.Equal(t, original.Component.Name, copied.Component.Name)
	assert.Equal(t, len(original.Signatures), len(copied.Signatures))

	// Modify original to ensure deep copy
	original.Component.Name = "modified"
	original.Signatures[0].Name = "modified-sig"
	assert.NotEqual(t, original.Component.Name, copied.Component.Name, "Modifying original component should not affect copy")
	assert.NotEqual(t, original.Signatures[0].Name, copied.Signatures[0].Name, "Modifying nested structures should not affect copy")
}

func TestDescriptor_DeepCopy_Nil(t *testing.T) {
	// Test
	var original *descriptorv2.Descriptor
	copied := original.DeepCopy()
