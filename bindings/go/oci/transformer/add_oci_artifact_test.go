...
func TestAddOCIArtifact_Transform(t *testing.T) {
	...
	require.NotNil(t, mockRepo.creds)
	ociCreds, ok := mockRepo.creds.(*ocicredsv1.OCICredentials)
	require.True(t, ok, "expected *ocicredsv1.OCICredentials, got %T", mockRepo.creds)
