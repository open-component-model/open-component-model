...
type ResourceRepository interface {
	...
	UploadResource(ctx context.Context, source *descriptor.Resource, content blob.ReadOnlyBlob) (resourceAfterUpload *descriptor.Resource, err error)
...
type SourceRepository interface {
	...
	// otherwise the upload will fail
	UploadSource(ctx context.Context, source *descriptor.Source, content blob.ReadOnlyBlob) (sourceAfterUpload *descriptor.Source, err error)
