...
func TestOCIResourceStream_Fetch(t *testing.T) {
	...
	s := &OCIResourceStream{ReadOnlyGraphStorage: store, Descriptor: layerDesc, CopyOpts: oras.DefaultCopyGraphOptions}
...
func TestOCIResourceStream_Root(t *testing.T) {
	...
	s := &OCIResourceStream{ReadOnlyGraphStorage: store, Descriptor: desc, CopyOpts: oras.DefaultCopyGraphOptions}
...
func TestOCIResourceStream_Materialize(t *testing.T) {
	...
	s := &OCIResourceStream{ReadOnlyGraphStorage: store, Descriptor: manifestDesc, CopyOpts: oras.DefaultCopyGraphOptions, TempDir: t.TempDir()}
...
func TestOCIResourceStream_CopyGraph(t *testing.T) {
	...
	s := &OCIResourceStream{ReadOnlyGraphStorage: srcStore, Descriptor: manifestDesc, CopyOpts: oras.DefaultCopyGraphOptions}
