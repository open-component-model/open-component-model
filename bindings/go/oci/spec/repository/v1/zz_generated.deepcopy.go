...
func (in *CTFRepository) DeepCopyInto(out *CTFRepository) {
	*out = *in
	out.Type = in.Type
	return
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new CTFRepository.
func (in *CTFRepository) DeepCopy() *CTFRepository {
	if in == nil {
		return nil
	}
	out := new(CTFRepository)
	in.DeepCopyInto(out)
	return out
}

// DeepCopyTyped is an autogenerated deepcopy function, copying the receiver, creating a new runtime.Typed.
func (in *CTFRepository) DeepCopyTyped() runtime.Typed {
