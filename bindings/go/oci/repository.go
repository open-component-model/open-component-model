...
type OCMComponentVersionRepository interface {
	...
	AddComponentVersion(ctx context.Context, descriptor *descriptorv2.Descriptor) error
	...
	GetComponentVersion(ctx context.Context, component, version string) (*descriptorv2.Descriptor, error)
	...
	AddLocalResource(ctx context.Context, component, version string, res *descriptorv2.Resource, content blob.ReadOnlyBlob) (newRes *descriptorv2.Resource, err error)
	...
	// can be returned.
	GetLocalResource(ctx context.Context, component, version string, identity map[string]string) (descriptorv2.LocalBlob, error)
}
...
type OCMResourceRepository interface {
	UploadResource(ctx context.Context, res *descriptorv2.Resource, content blob.ReadOnlyBlob) (newRes *descriptorv2.Resource, err error)
	DownloadResource(ctx context.Context, res *descriptorv2.Resource) (content blob.ReadOnlyBlob, err error)
}
