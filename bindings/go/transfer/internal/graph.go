...
func addUploadTransformation(v2desc *descriptorv2.Descriptor, id string, envID string, toSpec, fromSpec runtime.Typed, tgd *transformv1alpha1.TransformationGraphDefinition, resourceTransformIDs map[int]string) error {
	...
	// Carry the source repository so the upload transformer can copy attestation
	// referrers of the component version manifest to the target after upload.
	if fromSpec != nil {
