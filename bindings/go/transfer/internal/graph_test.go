...
func TestBuildGraphDefinition_NoResources(t *testing.T) {
	...
	tgd, err := BuildGraphDefinition(t.Context(), roots, 0, transferv1alpha1.CopyModeLocalBlobResources, transferv1alpha1.UploadAsDefault)
...
func TestBuildGraphDefinition_OCIImageWithCopyAllResources(t *testing.T) {
	...
	tgd, err := BuildGraphDefinition(t.Context(), roots, 0, transferv1alpha1.CopyModeAllResources, transferv1alpha1.UploadAsDefault)
	require.NoError(t, err)
...
func TestBuildGraphDefinition_OCIImageUploadAsOCIArtifact(t *testing.T) {
	...
	tgd, err := BuildGraphDefinition(t.Context(), roots, 0, transferv1alpha1.CopyModeAllResources, transferv1alpha1.UploadAsOciArtifact)
	require.NoError(t, err)
...
func TestBuildGraphDefinition_Recursive(t *testing.T) {
	...
	tgd, err := BuildGraphDefinition(t.Context(), roots, -1, transferv1alpha1.CopyModeLocalBlobResources, transferv1alpha1.UploadAsDefault)
	require.NoError(t, err)
...
func TestBuildGraphDefinition_ResolverError(t *testing.T) {
	...
	_, err := BuildGraphDefinition(t.Context(), roots, 0, transferv1alpha1.CopyModeLocalBlobResources, transferv1alpha1.UploadAsDefault)
	require.Error(t, err)
}
...
func TestBuildGraphDefinition_NoCleanupWhenResourcesSkipped(t *testing.T) {
	sourceRepo := testOCIRepo("ghcr.io/source")
	targetRepo := testOCIRepo("ghcr.io/target")
	// OCI image resource is skipped in transferv1alpha1.CopyModeLocalBlobResources
	desc := testDescriptor("ocm.software/test", "1.0.0",
		[]descriptor.Resource{ociImageResource("my-image", "1.0.0", "oci://ghcr.io/org/image:v1")}, nil)
	resolver := testResolverFor("ocm.software/test", "1.0.0", sourceRepo, desc)
	roots := testTransferRoots("ocm.software/test", "1.0.0", targetRepo, resolver)
...
func TestBuildGraphDefinition_DockerManifestLocalBlob_UploadedAsOCIArtifact(t *testing.T) {
	...
	tgd, err := BuildGraphDefinition(t.Context(), roots, 0, transferv1alpha1.CopyModeLocalBlobResources, transferv1alpha1.UploadAsOciArtifact)
	require.NoError(t, err)
