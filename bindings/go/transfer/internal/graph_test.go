...
func TestBuildGraphDefinition_NoResources(t *testing.T) {
	...
	tgd, err := BuildGraphDefinition(t.Context(), roots, transferv1alpha1.Config{CopyMode: transferv1alpha1.CopyModeLocalBlobResources, UploadType: transferv1alpha1.UploadAsLocalBlob})
...
func TestBuildGraphDefinition_OCIImageWithCopyAllResources(t *testing.T) {
	...
	tgd, err := BuildGraphDefinition(t.Context(), roots, transferv1alpha1.Config{CopyMode: transferv1alpha1.CopyModeAllResources, UploadType: transferv1alpha1.UploadAsLocalBlob})
	require.NoError(t, err)
...
func TestBuildGraphDefinition_Recursive(t *testing.T) {
	...
	tgd, err := BuildGraphDefinition(t.Context(), roots, transferv1alpha1.Config{Recursive: transferv1alpha1.RecursiveInfinite, CopyMode: transferv1alpha1.CopyModeLocalBlobResources, UploadType: transferv1alpha1.UploadAsLocalBlob})
	require.NoError(t, err)
...
func TestBuildGraphDefinition_ResolverError(t *testing.T) {
	...
	_, err := BuildGraphDefinition(t.Context(), roots, transferv1alpha1.Config{CopyMode: transferv1alpha1.CopyModeLocalBlobResources, UploadType: transferv1alpha1.UploadAsLocalBlob})
	require.Error(t, err)
}
