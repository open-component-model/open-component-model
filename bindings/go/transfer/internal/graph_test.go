...
func TestBuildGraphDefinition_NoResources(t *testing.T) {
	...
	tgd, err := BuildGraphDefinition(t.Context(), roots, false, transferv1alpha1.CopyModeLocalBlobResources, transferv1alpha1.UploadAsDefault)
...
func TestBuildGraphDefinition_OCIImageWithCopyAllResources(t *testing.T) {
	...
	tgd, err := BuildGraphDefinition(t.Context(), roots, false, transferv1alpha1.CopyModeAllResources, transferv1alpha1.UploadAsDefault)
	require.NoError(t, err)
...
func TestBuildGraphDefinition_Recursive(t *testing.T) {
	...
	tgd, err := BuildGraphDefinition(t.Context(), roots, true, transferv1alpha1.CopyModeLocalBlobResources, transferv1alpha1.UploadAsDefault)
	require.NoError(t, err)
...
func TestBuildGraphDefinition_ResolverError(t *testing.T) {
	...
	_, err := BuildGraphDefinition(t.Context(), roots, false, transferv1alpha1.CopyModeLocalBlobResources, transferv1alpha1.UploadAsDefault)
	require.Error(t, err)
}
