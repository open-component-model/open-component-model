...
// SetType is an autogenerated setter function, useful for type inference and defaulting.
func (t *JFrogHelmUploaderConfig) SetType(typ runtime.Type) {
	t.Type = typ
}

// GetType is an autogenerated getter function, useful for type inference and defaulting.
func (t *JFrogHelmUploaderConfig) GetType() runtime.Type {
	return t.Type
}

// SetType is an autogenerated setter function, useful for type inference and defaulting.
func (t *HTTPUploaderConfig) SetType(typ runtime.Type) {
	t.Type = typ
}

// GetType is an autogenerated getter function, useful for type inference and defaulting.
func (t *HTTPUploaderConfig) GetType() runtime.Type {
	return t.Type
}
