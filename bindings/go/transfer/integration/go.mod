...
require (
	...
	ocm.software/open-component-model/bindings/go/helm v0.0.0-20260417071914-50137d2b3f6f // indirect
	ocm.software/open-component-model/bindings/go/signing v0.0.0-20260417071914-50137d2b3f6f // indirect
