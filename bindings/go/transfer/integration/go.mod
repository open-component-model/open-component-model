...
require (
	...
	ocm.software/open-component-model/bindings/go/descriptor/normalisation v0.0.0-20260416102202-f251beded4be // indirect
	ocm.software/open-component-model/bindings/go/helm v0.0.0-20260416131247-22074468c601 // indirect
	ocm.software/open-component-model/bindings/go/signing v0.0.0-20260416102202-f251beded4be // indirect
