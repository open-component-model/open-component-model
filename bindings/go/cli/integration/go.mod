module ocm.software/open-component-model/bindings/go/cli/integration

go 1.26.5

replace ocm.software/open-component-model/bindings/go => ../..
...
require (
	...
	ocm.software/open-component-model/bindings/go v0.0.11
