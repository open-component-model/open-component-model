...
func NewTransport(cfg *httpv1alpha1.TimeoutConfig) *http.Transport {
...
// and the non-nil fields on cfg override them. It is unexported and reachable
// from tests via export_test.go so the configured values can be asserted
// without having to dial a real network endpoint.
