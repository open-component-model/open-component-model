...
require (
	...
	ocm.software/open-component-model/bindings/go/constructor v0.0.0-20250716114516-653941b36874
...
require (
	...
	ocm.software/open-component-model/bindings/go/oci v0.0.1 // indirect
