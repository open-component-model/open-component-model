...
func TestRegisterResourcePlugin(t *testing.T) {
	...
	r.NoError(err)
	r.Equal(`{"capabilities":[{"supportedAccessTypes":[{"aliases":null,"jsonSchema":null,"type":"DummyRepository/v1"}],"type":"resourceRepository","typeToJSONSchema":{"DummyRepository/v1":""}}]}`, string(content))
