...
func (p *RepositoryPlugin) GetGlobalResource(ctx context.Context, req *v1.GetResourceRequest, credentials map[string]string) (*v1.GetGlobalResourceResponse, error) {
...
func (p *RepositoryPlugin) AddGlobalResource(ctx context.Context, req *v1.PostResourceRequest, credentials map[string]string) (*v1.AddGlobalResourceResponse, error) {
