...
func TestRegisterInputProcessor(t *testing.T) {
	...
	r.NoError(err)
	r.Equal(`{"capabilities":[{"supportedInputTypes":[{"aliases":null,"jsonSchema":null,"type":"DummyRepository/v1"}],"type":"inputRepository","typeToJSONSchema":{"DummyRepository/v1":""}}]}`, string(content))
