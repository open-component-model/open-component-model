...
func RegisterInternalComponentVersionRepositoryPlugin[T runtime.Typed](
	...
	p componentrepository.ComponentVersionRepositoryProvider,
	prototype T,
) error {
	r.mu.Lock()
	defer r.mu.Unlock()
...
type RepositoryRegistry struct {
	...
	internalComponentVersionRepositoryPlugins map[runtime.Type]componentrepository.ComponentVersionRepositoryProvider
...
func (r *RepositoryRegistry) GetPlugin(ctx context.Context, spec runtime.Typed) (componentrepository.ComponentVersionRepositoryProvider, error) {
	r.mu.Lock()
	defer r.mu.Unlock()
...
func NewComponentVersionRepositoryRegistry(ctx context.Context) *RepositoryRegistry {
	return &RepositoryRegistry{
		...
		internalComponentVersionRepositoryPlugins: make(map[runtime.Type]componentrepository.ComponentVersionRepositoryProvider),
	}
}
