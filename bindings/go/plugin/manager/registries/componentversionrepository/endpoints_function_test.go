...
func TestRegisterComponentVersionRepository(t *testing.T) {
	...
	r.NoError(err)
	r.Equal(`{"capabilities":[{"supportedRepositorySpecTypes":[{"aliases":null,"jsonSchema":null,"type":"DummyRepository/v1"}],"type":"componentVersionRepository","typeToJSONSchema":{"DummyRepository/v1":""}}]}`, string(content))
