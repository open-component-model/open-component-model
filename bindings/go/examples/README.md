...
| 7    | [`07_http_config_test.go`](07_http_config_test.go) | **HTTP Configuration**       | Global timeouts, per-host overrides, retry policy, wiring into OCI provider    |
         ...
         └──────┬──────┘   │   └──────┬──────┘
                ...
                └──────────┼──────────┘
                    ...
                    └──────┬──────┘
                           │
                    ┌──────▼──────┐
                    │ 7. HTTP     │  Timeouts, retry
                    │   Config    │  policy, per-host
                    └──────┬──────┘
                           │
                    ┌──────▼──────┐
