...
// given wget URL. It is shared by the wget access type and the wget input method
// so that credentials configured for a host resolve identically whether the
// resource is declared via an access spec or an input spec.
