...
//
// The canonical type is "GitHub" (brand casing). The lowercase "github" spelling
// used by old OCM (https://github.com/open-component-model/ocm/blob/main/api/ocm/extensions/accessmethods/github/method.go)
// is retained as a deprecated alias so existing component descriptors keep resolving.
//
...
type GitHub struct {
	...
	// +ocm:jsonschema-gen:enum:deprecated=github/v1,github
