...
require (
	...
	github.com/fluxcd/pkg/ssa v0.76.0 // indirect
...
// github.com/go-ini/ini was retired upstream in favor of gopkg.in/ini.v1.
// v1.67.0 is the last release served under the old github path; v1.67.1+
