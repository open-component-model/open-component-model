...
description: "Welcome to your onboarding journey for Open Delivery Gear (ODG) 👋! This page contains a curated reading list that presents several sources in a meaningful…"
weight: 10
toc: true
---
...
Please skip to [Security and Compliance Automation with ODG]({{< relref "/docs/getting-started/odg/introduction.md" >}}#security-and-compliance-automation-with-odg)
{{< /callout >}}
...
## Security and Compliance Automation with ODG {#security-and-compliance-automation-with-odg}
...
Read more: [Odg Architecture]({{< relref "/docs/concepts/odg/odg-architecture.md" >}})
...
Read more: [Contributing Extension]({{< relref "/docs/tutorials/odg/contributing-extension.md" >}})
