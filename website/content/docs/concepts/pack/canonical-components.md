...
hasMermaid: true
aliases:
  - /docs/concepts/canonical-components/
---
...
A [component reference]({{< relref "docs/concepts/pack/component-identity.md" >}}) in OCM carries only a component name, version, and an optional digest. It never includes a repository URL, registry address, or storage path.
...
This design is what makes OCM's [transfer model]({{< relref "docs/concepts/transfer/transfer-concept.md" >}}) possible: artifacts can move across registry boundaries, air gaps, and organizational boundaries without losing integrity or provenance.
