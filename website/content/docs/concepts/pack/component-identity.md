...
toc: true
aliases:
  - /docs/concepts/component-identity/
---
...
The `access.type` also determines which [resource repository]({{< relref "docs/concepts/pack/resource-repositories.md" >}}) handles the actual download and upload of the artifact. Each resource repository knows how to interact with a specific storage backend and how to resolve the credentials needed to access it.
...
For hands-on signing instructions, see [Sign Component Versions]({{< relref "docs/how-to/sign/sign-component-version.md" >}}).
...
- [Resource Repositories]({{< relref "docs/concepts/pack/resource-repositories.md" >}}): how access types map to storage backends for downloading and uploading resources.
