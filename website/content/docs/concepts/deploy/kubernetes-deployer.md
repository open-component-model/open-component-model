...
hasMermaid: true
aliases:
  - /docs/concepts/kubernetes-deployer/
---
...
composition, skip kro entirely. The [Deploy Manifests with Deployer]({{< relref "/docs/how-to/deploy/deploy-manifests-with-deployer.md" >}})
