...
For the full picture of how artifacts move between repositories, see [Transfer and Transport]({{< relref "docs/concepts/transfer/transfer-concept.md" >}}).

## What's Next?

- [How-To: Add and Verify Ownership Information]({{< relref "docs/how-to/pack/add-and-verify-ownership.md" >}}) — opt a
  resource into ownership tracking and verify the ownership record.

## Related Documentation

- [Concept: Resource Repositories]({{< relref "docs/concepts/pack/resource-repositories.md" >}}) — how OCM stores and
  authenticates against the registries where resources (and their ownership records) live.
- [Concept: Transfer and Transport]({{< relref "docs/concepts/transfer/transfer-concept.md" >}}) — how component versions and
  their resources move between repositories.
- [Concept: Signing and Verification]({{< relref "docs/concepts/sign/signing-and-verification-concept.md" >}}) — how OCM
