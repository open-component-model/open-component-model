...
description: "The responsibles extension is able to determine responsibles based on configured rules, overriding or extending what is declared statically via the…"
weight: 50
toc: true
---
...
the [odg.ocm.software/responsibles OCM label]({{< relref "/docs/reference/odg/ocm-labels.md" >}}#odgocmsoftwareresponsibles-v1).
...
[issue-replicator extension]({{< relref "/docs/concepts/odg/issue-replicator.md" >}}) as option
