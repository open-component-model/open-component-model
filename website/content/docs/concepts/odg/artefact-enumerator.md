...
description: "The artefact-enumerator extension periodically checks the configured OCM artefacts and available runtime artefacts and takes care of the lifecycle of their…"
weight: 30
toc: true
---
## Purpose
...
process them (e.g.
[issue-replicator extension]({{< relref "/docs/concepts/odg/issue-replicator.md" >}})). Artefacts
...
### Compliance Snapshots {#compliance-snapshots}
...
[issue-replicator]({{< relref "/docs/concepts/odg/issue-replicator.md" >}})) to react upon those
...
### Backlog Item {#example-backlog-item}
...
### Runtime Artefact {#example-runtime-artefact}
