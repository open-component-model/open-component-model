...
description: "Open Delivery Gear (ODG) is a Kubernetes-native compliance automation engine designed for continuous security and compliance scanning of software components…"
weight: 10
toc: true
hasMermaid: true
---
...
### Scanner Extensions {#scanner-extensions}
...
- See [Contributing Extension]({{< relref "/docs/tutorials/odg/contributing-extension.md" >}}) for development guide
