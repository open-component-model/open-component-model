...
description: "The issue-replicator extension is responsible for the GitHub issue lifecycle (create/update/close) for issues of the configured artefacts and finding types.…"
weight: 40
toc: true
---
...
### Artefact Groups {#artefact-groups}
...
### Compliance Snapshots {#issue-replicator-compliance-snapshots}
...
[artefact-enumerator extension]({{< relref "/docs/concepts/odg/artefact-enumerator.md" >}}) for more
...
via the [artefact-enumerator extension]({{< relref "/docs/concepts/odg/artefact-enumerator.md" >}}).

![Issues Overview](/docs/odg/issues-overview.svg)
...
2. *Extension*
   ...
   The [responsibles extension]({{< relref "/docs/concepts/odg/responsibles.md" >}}) tries to
