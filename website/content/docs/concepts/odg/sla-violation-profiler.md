...
description: "The SLA-Violation-Profiler derives auditable evidence of Service Level Agreement (SLA) compliance from findings that already exist in the ODG database. For…"
weight: 70
toc: true
hasMermaid: true
---
...
See [Data Model]({{< relref "/docs/concepts/odg/data-model.md" >}}) for the surrounding
...
database. See [Run Sql Statements]({{< relref "/docs/how-to/odg/run-sql-statements.md" >}}) for instructions
