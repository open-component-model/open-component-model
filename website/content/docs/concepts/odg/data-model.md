...
description: "The data model of the Open Delivery Gear intends to correlate typed metadata from multiple sources with Artefacts said metadata is related to. Artefacts can…"
weight: 20
toc: true
---
...
![Fig. 1: Artefact Metadata Model](/docs/odg/artefact-metadata.svg)
...
![Fig. 2: General Overview](/docs/odg/general-overview.svg)
...
2. *Finding Types*
   ...
   fallback (see
   [issue-replicator extension]({{< relref "/docs/concepts/odg/issue-replicator.md" >}})). The
...
### Artefact Scan Info {#artefact-scan-info}
