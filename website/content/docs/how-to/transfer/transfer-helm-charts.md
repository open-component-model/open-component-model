...
- Write access to a target OCI registry with [credentials configured]({{< relref "docs/how-to/transfer/configure-multiple-credentials.md" >}})
...
see [Transfer and Transport]({{< relref "docs/concepts/transfer/transfer-concept.md" >}}).
...
- **For air-gapped environments**, first transfer to a CTF archive, move it across the boundary, then import into the target registry.
  See [Transfer Components Across an Air Gap]({{< relref "docs/how-to/transfer/air-gap-transfer.md" >}}).

## Next Steps

- [How to: Transfer Components Across an Air Gap]({{< relref "docs/how-to/transfer/air-gap-transfer.md" >}}) - Transfer components between disconnected networks
- [How-To: Download Resources from Component Versions]({{< relref "docs/how-to/pack/download-resources-from-component-versions.md" >}}) - Download individual resources from a component version

## Related documentation

- [Concept: Transfer and Transport]({{< relref "docs/concepts/transfer/transfer-concept.md" >}}) - Understand how OCM moves component versions between repositories
