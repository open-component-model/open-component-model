...
- [How-To: Transfer Components across an Air Gap]({{< relref "docs/how-to/transfer/air-gap-transfer.md" >}}) — move component versions into isolated networks
- [How-To: Configure Credentials for Multiple Registries]({{< relref "docs/how-to/transfer/configure-multiple-credentials.md" >}}) — pair HTTP config with credential setup in the same config file
