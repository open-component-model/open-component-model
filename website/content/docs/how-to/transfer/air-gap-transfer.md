...
- The public key used to sign the component version, configured in `.ocmconfig` (see [Signing and Verification]({{< relref "docs/tutorials/sign/plain.md" >}}) for setup)
...
Confirm integrity and provenance before transferring. The OCM CLI resolves verification credentials from your [`.ocmconfig`]({{< relref "docs/getting-started/ocm-cli-installation.md" >}}) automatically. For background on how signing works, see [Signing and Verification]({{< relref "docs/tutorials/sign/plain.md" >}}).
...
You should see: `SIGNATURE VERIFICATION SUCCESSFUL` and exit code `0`. For detailed verification options, see [Signing and Verification]({{< relref "docs/tutorials/sign/plain.md" >}}).

> **Tip: CTF as source**
>
> If your source is a [CTF archive]({{< relref "docs/concepts/transfer/transfer-concept.md" >}}) rather than a registry, use the archive path:
>
> ```bash
...
Create a self-contained [CTF archive]({{< relref "docs/concepts/transfer/transfer-concept.md" >}}) that bundles all resource artifacts and transitively referenced [component versions]({{< relref "docs/concepts/pack/component-identity.md" >}}). See [Transfer and Transport]({{< relref "docs/concepts/transfer/transfer-concept.md" >}}) for details on the `--copy-resources` flag.
...
>
> The CTF archive is a fully functional OCM repository. You can inspect component versions or [download resources]({{< relref "docs/how-to/pack/download-resources-from-component-versions.md" >}}) directly from it without importing into a registry first:
>
> ```bash
...
On the air-gapped side, transfer the CTF archive into the target registry. The target registry must have [credentials configured]({{< relref "docs/how-to/transfer/configure-multiple-credentials.md" >}}) in your `.ocmconfig`.
...
Confirm the [component version]({{< relref "docs/concepts/pack/component-identity.md" >}}) is available in the target registry:
...
Then verify the signature to confirm it survived the [transfer]({{< relref "docs/concepts/transfer/transfer-concept.md" >}}) intact:
...
see [Credentials in .ocmconfig]({{< relref "docs/how-to/transfer/configure-multiple-credentials.md" >}}).
...
See [Signing and Verification]({{< relref "docs/tutorials/sign/plain.md" >}}).
...
- [How-To: Deploy a Helm Chart (Bootstrap)]({{< relref "docs/tutorials/deploy/deploy-helm-chart-bootstrap.md" >}}) - Deploy component resources into a Kubernetes cluster

## Related Documentation

- [Concept: Transfer and Transport]({{< relref "docs/concepts/transfer/transfer-concept.md" >}}) - Understand the transfer model, resource handling, and signature preservation
- [Tutorial: Signing and Verification]({{< relref "docs/tutorials/sign/plain.md" >}}) - Learn how to sign and verify component versions
