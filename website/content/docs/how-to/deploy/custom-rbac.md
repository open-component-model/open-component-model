...
- [Concept: OCM controllers]({{< relref "/docs/concepts/deploy/ocm-controllers.md" >}}) - OCM Controllers
...
and kro]({{< relref "/docs/tutorials/deploy/deploy-helm-chart-bootstrap.md" >}}) and [Deploy an Application from
Chained RGDs with OCM and kro]({{< relref "/docs/tutorials/deploy/deploy-chained-rgds.md" >}}) for two worked
examples of the specific kinds each pattern needs.

## Related Documentation

- [Concept: OCM controllers]({{< relref "/docs/concepts/deploy/ocm-controllers.md" >}}) - Learn how the OCM Controllers work and how they interact with deployers and Kubernetes resources.
