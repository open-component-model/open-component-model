...
toc: true
aliases:
  - /docs/how-to/verify-component-version-controller/
---
...
- A [signed component version]({{< relref "docs/how-to/sign/sign-component-version.md" >}}) in a local CTF
  archive
- The public key file at `/tmp/keys/public-key.pem`
  (from [Generate Signing Keys]({{< relref "docs/how-to/sign/generate-signing-keys.md" >}}))
...
- [Concept: Signing and Verification]({{< relref "docs/concepts/sign/signing-and-verification-concept.md" >}}) -
  Understand how OCM signing works
- [How-To: Verify Component Versions (CLI)]({{< relref "docs/how-to/sign/verify-component-version.md" >}}) -
  Verify signatures using the CLI
- [How-To: Configure Credentials for OCM Controllers]({{< relref "docs/how-to/deploy/configure-credentials-ocm-controllers.md" >}}) -
