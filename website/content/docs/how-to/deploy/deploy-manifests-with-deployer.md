...
toc: true
aliases:
  - /docs/how-to/deploy-manifests-with-deployer/
---
...
For details on how the Deployer uses ApplySets, see [OCM Controllers]({{< relref "/docs/concepts/deploy/ocm-controllers.md" >}}).
{{< /callout >}}
{{< /step >}}
...
- [Tutorial: Deploy Helm Charts with Bootstrap]({{< relref "/docs/tutorials/deploy/deploy-helm-chart-bootstrap.md" >}}) — Advanced deployment with kro and Flux orchestration
