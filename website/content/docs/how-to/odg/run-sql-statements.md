---
title: "Run custom SQL commands in ODG"
description: "Establish a psql connection to the ODG database for executing custom SQL queries."
weight: 90
toc: true
---
## Goal
...
To effectively query ODG at the SQL level, you need to understand the underlying data model. See [Data Model]({{< relref "/docs/concepts/odg/data-model.md" >}}) for details.
