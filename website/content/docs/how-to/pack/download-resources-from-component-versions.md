...
As mentioned in the [concept document for Component Identity]({{< relref "/docs/concepts/pack/component-identity.md#component-repositories-and-storage" >}}),
...
- [Concept: Component Identity]({{< relref "/docs/concepts/pack/component-identity.md" >}}) - Understanding component structure
