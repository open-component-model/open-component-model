...
- A portable [CTF archive]({{< relref "docs/concepts/transfer/transfer-concept.md#common-transport-format-ctf" >}}) ready for transfer across registries and air-gapped environments
...
- Familiarity with [the component constructor]({{< relref "docs/tutorials/pack/advanced-component-constructor.md" >}})
...
- [Create a Multi-Component Product]({{< relref "docs/tutorials/pack/advanced-component-constructor.md" >}}) — advanced constructor patterns with nesting, labels, and sources
