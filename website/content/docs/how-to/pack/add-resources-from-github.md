...
toc: true
aliases:
  - /docs/how-to/add-resources-from-github/
---
...
[Configure credentials]({{< relref "docs/how-to/transfer/configure-multiple-credentials.md" >}}) of type
...
- [How-To: Sign a Component Version]({{< relref "docs/how-to/sign/sign-component-version.md" >}}) - Cover the digest you just recorded with
  a signature
