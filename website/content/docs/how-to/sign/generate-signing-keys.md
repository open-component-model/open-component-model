...
toc: true
aliases:
  - /docs/how-to/sign-and-verify/generate-signing-keys/
---
...
- [How-to: Sign a Component Version]({{< relref "docs/how-to/sign/sign-component-version.md" >}}) - Use your private key to sign components
- [How-to: Verify a Component Version]({{< relref "docs/how-to/sign/verify-component-version.md" >}}) - Share your public key and verify signatures
...
- [Tutorial: Sign Your First Component]({{< relref "docs/tutorials/sign/plain.md" >}}) - A hands-on tutorial for signing components end-to-end
- [Tutorial: GPG Signatures]({{< relref "docs/tutorials/sign/gpg.md" >}}) - End-to-end GPG signing tutorial
