...
aliases:
  ...
  - /docs/how-to/sign-and-verify/verify-component-versions/
---
...
- [Verification credentials configured]({{< relref "docs/how-to/sign/configure-signing-credentials.md" >}}) with the public key
- A signed component version to verify in your current directory, here we use the `helloworld` component version from the [getting started guide]({{< relref "create-component-version.md" >}}) that you've signed in the [How-To: Sign Component Versions]({{< relref "docs/how-to/sign/sign-component-version.md" >}}) guide.
...
See [Configure Signing Credentials]({{< relref "docs/how-to/sign/configure-signing-credentials.md" >}}).
...
- [OCM CLI installed]({{< relref "ocm-cli-installation.md" >}})
- [Verification credentials configured]({{< relref "docs/how-to/sign/configure-signing-credentials.md" >}}) with the public key
- A GPG-signed component version (see the [Sign Component Versions]({{< relref "docs/how-to/sign/sign-component-version.md" >}}) how-to)
...
If you're verifying a signature **someone else** produced, follow [How-To: Configure Signing Credentials → GPG]({{< relref "docs/how-to/sign/configure-signing-credentials.md" >}}) using only the signer's public key (`publicKeyPGPFile`); the `privateKeyPGPFile` entry is not needed for verification.

Add a `verifier` to the same `signing.config.ocm.software/v1alpha1` entry you created as the signer in the [sign how-to → GPG tab]({{< relref "docs/how-to/sign/sign-component-version.md" >}}). RSA is the default when no verifier is configured, so this is what tells `ocm verify` to use GPG:
...
For the conceptual picture (how Fulcio, Rekor, and OIDC fit together), see [Identity-Based Trust (Sigstore)]({{< relref "docs/concepts/sign/signing-and-verification-concept.md#identity-based-trust-sigstore" >}}).
...
- [OCM CLI installed]({{< relref "ocm-cli-installation.md" >}})
- A component version signed with Sigstore (see [How-To: Sign Component Versions]({{< relref "docs/how-to/sign/sign-component-version.md" >}}))
- The expected signer identity (their OIDC email and which provider they logged in with)

{{< callout context="note" >}}
<!-- TODO(#2588): once the Sigstore tutorial lands on main, restore the relref to docs/tutorials/sign/sigstore.md around "Tutorial: Sigstore (Keyless)" -->
...
<!-- TODO(#2588): once the Sigstore tutorial lands on main, restore the relref to docs/tutorials/sign/sigstore.md around "Tutorial: Sigstore (Keyless) — Inspect the signature" -->
...
- A component version signed in CI (see the [Sigstore (CI)]({{< relref "docs/how-to/sign/sign-component-version.md" >}}) tab on the sign how-to)
...
- [How-to: Sign Component Versions]({{< relref "docs/how-to/sign/sign-component-version.md" >}}) — Add signatures to your components (RSA or Sigstore)
- [Tutorial: Signing and Verification]({{< relref "docs/tutorials/sign/plain.md" >}}) — Learn how to sign and verify components in a complete tutorial

## Related Documentation

- [Concept: Signing and Verification]({{< relref "docs/concepts/sign/signing-and-verification-concept.md" >}}) — Understand how OCM signing works
