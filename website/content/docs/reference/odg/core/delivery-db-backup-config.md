---
title: "Delivery Database Backup"
description: "The Delivery Database Backup extension is a cronjob which regularly creates backups of the PostgreSQL delivery database and stores them as local blobs in an…"
weight: 120
toc: true
---
