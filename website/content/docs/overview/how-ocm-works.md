...
- **Registry → CTF archive** — export to a portable file in [Common Transport Format (CTF)]({{< relref "docs/concepts/transfer/transfer-concept.md#common-transport-format-ctf" >}}) for air-gapped or offline transfer.
