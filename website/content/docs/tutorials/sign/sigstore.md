...
see [Concept: Sigstore (Keyless)]({{< relref "docs/concepts/sign/signing-and-verification-concept.md#sigstore-keyless" >}})
and [Concept: Identity-Based Trust]({{< relref "docs/concepts/sign/signing-and-verification-concept.md#identity-based-trust-sigstore" >}}).
...
- **Running an enterprise Sigstore stack?** [How-to: Sign Component Versions]({{< relref "docs/how-to/sign/sign-component-version.md" >}}) covers the `signingConfig` field and the `trusted_root_json` credential for private deployments.
- **Curious about the theory?** [Concept: Signing and Verification]({{< relref "docs/concepts/sign/signing-and-verification-concept.md" >}}) explains identity-based trust, how it differs from RSA key pinning, and why Sigstore works in air-gapped scenarios.
- **Other algorithms?** [Tutorial: Plain Signatures]({{< relref "docs/tutorials/sign/plain.md" >}}) (RSA key pair) and [Tutorial: Certificate Chains (PEM)]({{< relref "docs/tutorials/sign/pem.md" >}}) (PKI-based).
...
- [Concept: Signing and Verification]({{< relref "docs/concepts/sign/signing-and-verification-concept.md" >}}) — Identity-based trust and the Sigstore stack
- [How-to: Sign Component Versions]({{< relref "docs/how-to/sign/sign-component-version.md" >}}) — Task-oriented sign reference (RSA and Sigstore)
- [How-to: Verify Component Versions]({{< relref "docs/how-to/sign/verify-component-version.md" >}}) — Task-oriented verify reference
