...
For the conceptual background on key pinning vs. certificate chain trust, see [Trust Models]({{< relref "docs/concepts/sign/signing-and-verification-concept.md#trust-models" >}}).
...
- [Plain Signatures]({{< relref "docs/tutorials/sign/plain.md" >}}) -- Basic key-pair signing without certificate chains
- [Sigstore (Keyless)]({{< relref "docs/tutorials/sign/sigstore.md" >}}) -- Identity-based signing — no keys to manage
- [Configure Credentials for Signing]({{< relref "docs/how-to/sign/configure-signing-credentials.md" >}}) -- Full credential configuration reference
