...
For more details, see [How-to: Generate Signing Keys]({{< relref "docs/how-to/sign/generate-signing-keys.md" >}}).
{{< /step >}}
...
A detailed How-To guide is available here: [How-to: Configure Signing Credentials]({{< relref "docs/how-to/sign/configure-signing-credentials.md" >}}).
...
For more details, see [How-to: Configure Signing Credentials]({{< relref "docs/how-to/sign/configure-signing-credentials.md" >}}).
{{< /step >}}
...
- [How-to: Generate Signing Keys]({{< relref "docs/how-to/sign/generate-signing-keys.md" >}}) - Step-by-step creating RSA key pairs.
- [How-to: Configure Signing Credentials]({{< relref "docs/how-to/sign/configure-signing-credentials.md" >}}) - Set up OCM to use your keys for signing and verification.

## Related Documentation

- [Concept: Signing and Verification]({{< relref "docs/concepts/sign/signing-and-verification-concept.md" >}}) - Understand the theory behind OCM signing
- [Tutorial: Certificate Chains (PEM)]({{< relref "docs/tutorials/sign/pem.md" >}}) - Same RSA key pair, but with an X.509 chain instead of a bare public key
- [Tutorial: Sigstore (Keyless)]({{< relref "docs/tutorials/sign/sigstore.md" >}}) - Identity-based signing — no keys to manage
