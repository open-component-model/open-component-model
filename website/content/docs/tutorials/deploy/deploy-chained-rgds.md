...
toc: true
aliases:
  - /docs/tutorials/deploy-chained-rgds/
---
...
deliver both the same way described in [Concept: Kubernetes Deployer]({{< relref "docs/concepts/deploy/kubernetes-deployer.md" >}}):
...
artifact integrity, and localization adapts the reference at deploy time]({{< relref "docs/concepts/transfer/transfer-concept.md#localization" >}}).
...
(Continues from [Concept: Kubernetes Deployer]({{< relref "docs/concepts/deploy/kubernetes-deployer.md" >}}), which
...
Handling: References vs. Copies]({{< relref "docs/concepts/transfer/transfer-concept.md#resource-handling-references-vs-copies" >}})
...
For more details, see [Configure Credentials for Controllers]({{< relref "/docs/how-to/deploy/configure-credentials-ocm-controllers.md" >}}).
{{< /details >}}
...
- [Configure Credentials for Controllers]({{< relref "/docs/how-to/deploy/configure-credentials-ocm-controllers.md" >}}) for private registries
