...
aliases:
  ...
  - /docs/tutorials/deploy-helm-chart-bootstrap/
---
...
[Concept: Kubernetes Deployer]({{< relref "docs/concepts/deploy/kubernetes-deployer.md" >}}). The
...
- [How-to: Configure Credentials for Controllers]({{< relref "docs/how-to/deploy/configure-credentials-ocm-controllers.md" >}}) — Set up private registry access
