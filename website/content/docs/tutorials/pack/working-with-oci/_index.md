...
- [How-To: Transfer Components Across an Air Gap]({{< relref "docs/how-to/transfer/air-gap-transfer.md" >}}) — Transfer signed components through air-gapped environments
- [How-To: Download Resources from Component Versions]({{< relref "docs/how-to/pack/download-resources-from-component-versions.md" >}}) — Extract resources from components

## Related Documentation

- [Concept: Transfer and Transport]({{< relref "docs/concepts/transfer/transfer-concept.md" >}}) — Understand resource handling during transfer
