...
[Add Resources from HTTP URLs]({{< relref "docs/how-to/pack/add-resources-from-http-urls.md" >}}). This tutorial explains
...
- Comfortable adding a component version with `ocm add cv`; the
  [how-to]({{< relref "docs/how-to/pack/add-resources-from-http-urls.md" >}}) is a good warm-up
...
For how identities are matched and resolved, see [Understand Credential Resolution]({{< relref "docs/tutorials/transfer/credential-resolution.md" >}}).
...
- [How-To: Add Resources from HTTP URLs]({{< relref "docs/how-to/pack/add-resources-from-http-urls.md" >}}) - The task
