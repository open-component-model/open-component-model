...
and get all of them together to one location. For the why, see [Software Bills of Materials]({{< relref "docs/concepts/pack/sboms.md" >}}).
...
- [How-to: Download Resources from Component Versions]({{< relref "docs/how-to/pack/download-resources-from-component-versions.md" >}}) - The download command this tutorial builds on
- [How-to: Air-Gap Transfer]({{< relref "docs/how-to/transfer/air-gap-transfer.md" >}}) - Moving a component version by value, the case that decides which SBOM strategy works
...
- [Tutorial: Plain Signatures]({{< relref "docs/tutorials/sign/plain.md" >}}) - Signing the component version, which is what makes a linked SBOM trustworthy
- [Concept: Software Bills of Materials]({{< relref "docs/concepts/pack/sboms.md" >}}) - What an SBOM is and why OCM binds it to the component version
...
- [Signing and Verification]({{< relref "docs/tutorials/sign/plain.md" >}}) - Sign and verify component versions with cryptographic keys
