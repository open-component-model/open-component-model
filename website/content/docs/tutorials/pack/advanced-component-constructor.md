...
- [Tutorial: Plain Signatures]({{< relref "docs/tutorials/sign/plain.md" >}}) - add signing to your components
- [How-to: Transfer Helm Charts]({{< relref "docs/how-to/transfer/transfer-helm-charts.md" >}}) - transfer components to a remote registry

## Related documentation

- [Concept: Component Identity]({{< relref "docs/concepts/pack/component-identity.md" >}}) - understand how OCM identifies components
