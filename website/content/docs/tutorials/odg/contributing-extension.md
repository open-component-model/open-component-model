...
description: "For instructions on how to setup a local development environment, please refer to Local Setup."
weight: 10
toc: true
---
...
to [Local Setup]({{< relref "/docs/how-to/odg/local-setup.md" >}}).

## Model

For information on the `ArtefactMetadata` model and how to extend it, please
refer to [Data Model]({{< relref "/docs/concepts/odg/data-model.md" >}}).
...
## Findings Configuration {#findings-configuration}

If the extension emits findings (see [Data Model]({{< relref "/docs/concepts/odg/data-model.md" >}}) for information on the
...
1. *Kubernetes Cronjob*
   ...
   [Data Model]({{< relref "/docs/concepts/odg/data-model.md" >}}) requires the data to be always correlated to a certain
...
2. *Artefact-Enumerator*
   ...
   [artefact-enumerator extension]({{< relref "/docs/concepts/odg/artefact-enumerator.md" >}})). The
...
[Data Model]({{< relref "/docs/concepts/odg/data-model.md" >}}) via the ODG API is usually very similar. In case of
findings, there is a well-defined overview of the supported states of a finding
(see Fig. 1).

![Fig. 1: Finding State Machine](/docs/odg/finding-states.svg)
...
## Artefact-Enumerator {#artefact-enumerator}
...
## Issue-Replicator {#issue-replicator}

In order to enable the
[issue-replicator extension]({{< relref "/docs/concepts/odg/issue-replicator.md" >}}) to also report
