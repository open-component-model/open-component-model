...
| manager.image.digest | string | `""` | Controller image digest (e.g. sha256:...). When set, takes precedence over tag. |
...
| manager.image.tag | string | `"latest"` | Controller image tag (used when digest is not set) |
