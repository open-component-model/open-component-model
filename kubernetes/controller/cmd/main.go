...
func main() {
	...
	httpClient := provider.NewHTTPClient(provider.WithHttpConfig(httpConfig))
	...
	ociResourceRepoPlugin := ocires.NewResourceRepository(&filesystemv1alpha1.Config{}, httpConfig, ocires.WithUserAgent(creator))
