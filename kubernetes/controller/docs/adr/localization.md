...
In the official [Example](https://ocm.software/docs/tutorials/ocm-and-gitops/air-gapped-gitops-with-ocm-flux/),
...
It is important to note that these tools can afford this because they rely on *existing* templating capabilities of Helm or Kustomize.
