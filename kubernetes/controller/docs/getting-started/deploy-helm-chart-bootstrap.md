      ...
      template:
        ...
        spec:
          ...
          layerSelector:
            ...
            operation: copy
          url: oci://${string(resourceChart.status.additional.registry)}/${string(resourceChart.status.additional.repository)}
          ref:
            tag: ${string(resourceChart.status.additional.tag)}
      ...
      template:
        ...
        spec:
          ...
          values:
            ...
            image:
              repository: ${string(resourceImage.status.additional.registry)}/${string(resourceImage.status.additional.repository)}
              tag: ${string(resourceImage.status.additional.tag)}
```
