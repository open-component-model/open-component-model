...
//
// The pool mirrors the resolution worker pool but specializes for transfers:
//
...
//     support the deletion drain described in the ADR.
//   - On completion the pool broadcasts the affected requesters to all
//     subscribers; an [EventSource] turns those into reconcile requests.
//
