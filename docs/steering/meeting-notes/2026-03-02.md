...
- [x] Gerald to update the SIG Charter - Postponed, Gerald not present.
  - Charter is up to date.
- [ ] Jakob to announce SIG Runtime Contribution Possibility to the NeoNephos Project
    - [ ] Jakob to attempt to write a blob post on the NeoNephos website.
    - [ ] Gerald to check for a blog style page for announcements etc. on the website. (Jakob & Gerald to plan)
...
- [ ] Philipp to create a Session for the TSC+ODG Teams to align where to drive the ODG integration strategy-wise.
    - in the works
- [ ] Gerald to create issue on OCM Spec CSL License Adoption
