...
- Governance Model and Submission Process for OCM SIGs. Electronic vote chosen based on https://github.com/open-component-model/open-component-model/pull/858 and its approvals. Electronic vote without a meeting require a majority vote of all voting members of the TSC (4/6 votes needed). 4/6 votes reached on 2025-09-18
