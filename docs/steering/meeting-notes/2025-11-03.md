...
- [x] Update on TAC / TSC
  - [x] Update on the NeoNephos Guidelines
    - Dependency of the NeoNephos Project Guidelines based on completion and agreement of the NeoNephos Project Lifecycle (https://github.com/neonephos/tac/issues/4)
