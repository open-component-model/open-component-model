...
For governance specific to the Technical Steering Committee (TSC), see [docs/steering/GOVERNANCE.md](../steering/GOVERNANCE.md).

## 1. Roles

Each Working Group may include the following roles. Additional roles may be adopted and documented by the Working Group.

**1.1. Maintainer.** "Maintainers" are responsible for organizing activities around developing, maintaining, and updating the deliverables of the Working Group. Maintainers are also responsible for determining consensus and coordinating appeals. Each Working Group will designate one or more Maintainers. A Working Group may select a new or additional Maintainer(s) upon Approval of the Working Group Participants.

**1.2. Editor.** "Editors" are responsible for ensuring that the contents of deliverables accurately reflect the decisions made by the group and that documents adhere to formatting and content guidelines. Each Working Group will designate an Editor. A Working Group may select a new Editor upon Approval of the Working Group Participants.

**1.3. Participants.** "Participants" are those that have made Contributions to the Working Group subject to the [Community Specification License 1.0](https://github.com/CommunitySpecification/Community_Specification/blob/main/1._Community_Specification_License-v1.md).

**1.4. Code Owners.** "Code Owners" are Contributors who have earned the ability to modify source code, documentation, or other technical artifacts in a project repository. A Contributor may become a Code Owner by majority approval of the existing Code Owners. A Code Owner may be removed by majority approval of the other existing Code Owners.

For SIG-specific roles (Chair, Tech Lead, Voting Members), see the [SIG Handbook](SIGs/SIG-Handbook.md).
