...
| 7 | `maven` | `blob`, `credentials`, `descriptor/runtime`, `descriptor/v2`, `plugin`, `repository`, `runtime` |
| 8 | `transfer` | `blob`, `configuration`, `credentials`, `ctf`, `dag`, `descriptor/runtime`, `descriptor/v2`, `github`, `helm`, `http`, `maven`, `oci`, `repository`, `runtime`, `s3`, `signing`, `transform`, `wget` |
| 9 | `cli` | `blob`, `cel`, `configuration`, `constructor`, `credentials`, `ctf`, `dag`, `descriptor/normalisation`, `descriptor/runtime`, `descriptor/v2`, `github`, `gpg`, `helm`, `http`, `input/dir`, `input/file`, `input/utf8`, `maven`, `oci`, `plugin`, `repository`, `rsa`, `runtime`, `s3`, `signing`, `sigstore`, `transfer`, `transform`, `wget` |
