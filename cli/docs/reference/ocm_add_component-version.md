...
The "component-constructor" file supports environment variable substitution using Go template syntax.
...
Using environment variables in "component-constructor" files:

export COMPONENT_NAME="github.com/my-org/my-app"
export COMPONENT_VERSION="1.2.3"
export REGISTRY_URL="ghcr.io/my-org"
add component-version --repository ./archive --constructor component-constructor.yaml
```
...
```
      ...
      --idle-conn-timeout duration         HTTP idle connection timeout (e.g. "90s"). Use "0" to disable. Overrides config file value.
      ...
      --response-header-timeout duration   HTTP response header timeout (e.g. "10s"). Use "0" to disable. Overrides config file value.
      --retry-max-retry int                Maximum number of HTTP retry attempts. Use "0" to disable retries. Overrides config file value.
      --retry-max-wait duration            Maximum wait before retrying a failed HTTP request (e.g. "3s"). Use "0" to disable. Overrides config file value.
      --retry-min-wait duration            Minimum wait before retrying a failed HTTP request (e.g. "200ms"). Use "0" to disable. Overrides config file value.
      --tcp-dial-timeout duration          TCP dial timeout for establishing connections (e.g. "30s"). Use "0" to disable. Overrides config file value.
      --tcp-keep-alive duration            TCP keep-alive interval (e.g. "30s"). Use "0" to disable. Overrides config file value.
      ...
      --tls-handshake-timeout duration     TLS handshake timeout (e.g. "10s"). Use "0" to disable. Overrides config file value.
