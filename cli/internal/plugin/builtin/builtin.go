...
func Register(manager *manager.PluginManager, filesystemConfig *filesystemv1alpha1.Config, ownershipConfig *ownershipv1alpha1.Config, logger *slog.Logger) error {
