...
func (p *ResourceRepositoryPlugin) AddGlobalResource(ctx context.Context, request *resourcev1.AddGlobalResourceRequest, credentials map[string]string) (*resourcev1.AddGlobalResourceResponse, error) {
