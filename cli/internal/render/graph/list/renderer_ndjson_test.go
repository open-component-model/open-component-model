...
func TestRunRenderLoopNDJSON(t *testing.T) {
	synctest.Test(t, func(t *testing.T) {
		...
		renderer := New(ctx, graph, WithListSerializer(NewSerializer(WithVertexSerializerFunc(serializer), WithOutputFormat[string](render.OutputFormatNDJSON))))
...
func TestRenderOnceNDJSON(t *testing.T) {
	...
	renderer := New(ctx, graph, WithListSerializer(NewSerializer(WithOutputFormat[string](render.OutputFormatNDJSON))))
