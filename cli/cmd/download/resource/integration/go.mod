module ocm.software/open-component-model/cli/cmd/download/resource/integration
...
require (
	...
	ocm.software/open-component-model/bindings/go/configuration v0.0.6 // indirect
	ocm.software/open-component-model/bindings/go/constructor v0.0.0-20250816122110-cde8f3437bb7 // indirect
	ocm.software/open-component-model/bindings/go/credentials v0.0.1 // indirect
