...
require (
	...
	ocm.software/open-component-model/bindings/go/blob v0.0.8 // indirect
	ocm.software/open-component-model/bindings/go/constructor v0.0.0-20250816122110-cde8f3437bb7 // indirect
	ocm.software/open-component-model/bindings/go/ctf v0.2.0 // indirect
	ocm.software/open-component-model/bindings/go/dag v0.0.3-0.20250822081348-ae44f0a89de3 // indirect
	...
	ocm.software/open-component-model/bindings/go/repository v0.0.0-20250822081348-ae44f0a89de3 // indirect
