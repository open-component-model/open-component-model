...
import (
	...
	"ocm.software/open-component-model/cli/cmd/get/config"
	"ocm.software/open-component-model/cli/cmd/get/sbom"
)

// New represents any command that is related to retrieving ( "get"ting ) objects
func New() *cobra.Command {
	cmd := &cobra.Command{
		Use:   "get {component-version|component-versions|cv|cvs|config|cfg|sbom|sboms}",
