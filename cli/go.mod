...
require (
	...
	ocm.software/open-component-model/bindings/go/plugin v0.0.0-20250520091418-cc5a0fb57ffb
	ocm.software/open-component-model/bindings/go/runtime v0.0.0-20250520093648-0642d9778941
